...
| **Crop + resize + inference + L2, measured as one** | **9–43 ms** | **140–248 ms, median ~148 ms** (see note) |
...
> interval, and the 248 ms sample saturates it outright. The throttle holds for now; it has no
> headroom.
